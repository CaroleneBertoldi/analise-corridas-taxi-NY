...
mapa.locais = left_join(mapa.quadrantes, locais)
```
## Corridas de táxi
...
colnames(corridas.locais.origens)[length(corridas.locais.origens)] <- "pickup_quater"
...
colnames(corridas.locais.destinos)[length(corridas.locais.destinos)] <- "dropoff_quater"

...
A partir dos quadrantes top 5 de origem e destino, encontramos os locais de partida e de destinos mais comuns das corridas.

```{r }
locais.top.quater.origem = head(top.5.origens, n=1)$pickup_quater
...
#teste.rota = buscar.rotas(34, 29, 33,38)
teste.rota = buscar.rota(4, 1, 1, 4)
teste.rota
...
teste.rota.id = buscar.rota.por.corrida.id(corridas.dentro, 'id2875421')
teste.rota.id
```
